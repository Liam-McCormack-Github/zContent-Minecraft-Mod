...
public class EnchantmentSaturation extends Enchantment {

	public EnchantmentSaturation() {
		super(Rarity.VERY_RARE, ModEnchantments.WAND, new EntityEquipmentSlot[] {});
		this.setName("Saturation");
		this.setRegistryName(new ResourceLocation(Reference.MOD_ID + ":saturation"));
