...
public class EnchantmentInvisibility extends Enchantment {

	public EnchantmentInvisibility() {
		super(Rarity.VERY_RARE, 	ModEnchantments.WAND, new EntityEquipmentSlot[] {});
		this.setName("Invisibility");
		this.setRegistryName(new ResourceLocation(Reference.MOD_ID + ":invisibility"));
