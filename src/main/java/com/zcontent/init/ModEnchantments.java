            ...
            if (item.isItemEnchanted()) {
                ...
                for (Entry<Enchantment, Integer> entry : enchs.entrySet()) {
                    if (entry.getKey().getName().contentEquals("enchantment.Levitation")) {
                        event.player.addPotionEffect(new PotionEffect(MobEffects.LEVITATION, 2, 9, false, false));
                    }
                    if (entry.getKey().getName().contentEquals("enchantment.Speed")) {
                        event.player.addPotionEffect(new PotionEffect(MobEffects.SPEED, 180, 9, false, false));
                    }
                    if (entry.getKey().getName().contentEquals("enchantment.JumpBoost")) {
                        event.player.addPotionEffect(new PotionEffect(MobEffects.JUMP_BOOST, 180, 2, false, false));
                    }
                    if (entry.getKey().getName().contentEquals("enchantment.Invisibility")) {
                        event.player.addPotionEffect(new PotionEffect(MobEffects.INVISIBILITY, 180, 0, false, false));
                    }
                    if (entry.getKey().getName().contentEquals("enchantment.InstantHealth")) {
                        event.player.addPotionEffect(new PotionEffect(MobEffects.INSTANT_HEALTH, 180, 0, false, false));
                    }
                    if (entry.getKey().getName().contentEquals("enchantment.Haste")) {
                        event.player.addPotionEffect(new PotionEffect(MobEffects.HASTE, 180, 9, false, false));
                    }
                    if (entry.getKey().getName().contentEquals("enchantment.Glowing")) {
                        event.player.addPotionEffect(new PotionEffect(MobEffects.GLOWING, 180, 0, false, false));
                    }
                    if (entry.getKey().getName().contentEquals("enchantment.Absorption")) {
                        event.player.addPotionEffect(new PotionEffect(MobEffects.ABSORPTION, 180, 9, false, false));
                    }
                    if (entry.getKey().getName().contentEquals("enchantment.Strength")) {
                        event.player.addPotionEffect(new PotionEffect(MobEffects.STRENGTH, 180, 9, false, false));
                    }
                    if (entry.getKey().getName().contentEquals("enchantment.Saturation")) {
                        event.player.addPotionEffect(new PotionEffect(MobEffects.SATURATION, 180, 0, false, false));
                    }
                    if (entry.getKey().getName().contentEquals("enchantment.Luck")) {
                        event.player.addPotionEffect(new PotionEffect(MobEffects.LUCK, 180, 9, false, false));
                    }
                    if (entry.getKey().getName().contentEquals("enchantment.FireResistance")) {
                        event.player.addPotionEffect(new PotionEffect(MobEffects.FIRE_RESISTANCE, 180, 0, false, false));
                    }
                    if (entry.getKey().getName().contentEquals("enchantment.WaterBreathing")) {
                        event.player.addPotionEffect(new PotionEffect(MobEffects.WATER_BREATHING, 180, 0, false, false));
                    }
                    if (entry.getKey().getName().contentEquals("enchantment.NightVision")) {
                        event.player.addPotionEffect(new PotionEffect(MobEffects.NIGHT_VISION, 600, 0, false, false));
                    }
                    if (entry.getKey().getName().contentEquals("enchantment.Regeneration")) {
                        event.player.addPotionEffect(new PotionEffect(MobEffects.REGENERATION, 180, 0, false, false));
                    }
                    if (entry.getKey().getName().contentEquals("enchantment.Resistance")) {
                        event.player.addPotionEffect(new PotionEffect(MobEffects.RESISTANCE, 180, 9, false, false));
                    }
        ...
        if (event.player.hasItemInSlot(EntityEquipmentSlot.OFFHAND)) {
            ...
            if (item.isItemEnchanted()) {
                ...
                for (Entry<Enchantment, Integer> entry : enchs.entrySet()) {
                    ...
                    if (entry.getKey().getName().contentEquals("enchantment.Luck")) {
                        event.player.addPotionEffect(new PotionEffect(MobEffects.LUCK, 180, 0, false, false));
                    }
                    if (entry.getKey().getName().contentEquals("enchantment.FireResistance")) {
                        event.player.addPotionEffect(new PotionEffect(MobEffects.FIRE_RESISTANCE, 180, 0, false, false));
                    }
