...
public class RecipeTomeToEnchantableWand1 extends IForgeRegistryEntry.Impl<IRecipe> implements IRecipe {

    private static final Item thisWand = ModItems.enchantable_wand_1;
