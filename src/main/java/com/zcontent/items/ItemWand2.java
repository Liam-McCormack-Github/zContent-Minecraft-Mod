...
public class ItemWand2 extends Item implements IHasModel {

    public static UUID MOD_UUID = UUID.nameUUIDFromBytes("RangeModifier".getBytes());

    public ItemWand2(String name) {
    ...
    public Multimap<String, AttributeModifier> getItemAttributeModifiers(EntityEquipmentSlot equipmentSlot) {
        ...
        if (equipmentSlot == EntityEquipmentSlot.MAINHAND) {
            multimap.put(EntityPlayer.REACH_DISTANCE.getName(), new AttributeModifier(MOD_UUID, "Range Modifier", 15, 0));
        }
