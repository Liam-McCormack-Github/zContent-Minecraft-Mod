...
public class ToolSwordWithAttributes extends ToolSwordBase implements IHasModel {

    private final int rangeMainHand;
    private final int rangeOffHand;

    public ToolSwordWithAttributes(String name, CreativeTabs creativeTab, ToolMaterial material, int _rangeMainHand, int _rangeOffHand) {
