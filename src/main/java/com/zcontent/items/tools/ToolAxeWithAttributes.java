...
public class ToolAxeWithAttributes extends ToolAxeBase implements IHasModel {

    private final int rangeMainHand;
    private final int rangeOffHand;


    public ToolAxeWithAttributes(String name, CreativeTabs creativeTab, ToolMaterial material, float damage, float speed, int _rangeMainHand, int _rangeOffHand) {
        super(name, creativeTab, material, damage, speed);
