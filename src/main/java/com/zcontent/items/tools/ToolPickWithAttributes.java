...
public class ToolPickWithAttributes extends ToolPickBase implements IHasModel {

    private final int rangeMainHand;
    private final int rangeOffHand;

    public ToolPickWithAttributes(String name, CreativeTabs creativeTab, ToolMaterial material, int _rangeMainHand, int _rangeOffHand) {
